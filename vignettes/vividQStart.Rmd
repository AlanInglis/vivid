...
```
<center>
Fig 1.1: *Network plot of a SVM fit displaying 2-way interaction strength and individual variable importance. $x_1$ and $x_2$ show a strong interaction with $x_4$ being the most important for predicting $y$.*
</center>


### Generalized partial dependence pairs plot 

In this plot we use a generalised pairs plot matirx style layout (which we call GPDP) to display partial dependence plots (PDPs) in the upper triangle, individual conditional exception curves (allong with the aggregated 1-way partial dependence) on the diagonal and a scatterplot in the lower triangle.
