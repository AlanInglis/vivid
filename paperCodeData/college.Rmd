...
knitr::opts_chunk$set(echo = TRUE, warning = FALSE, message = FALSE,  fig.width = 5, fig.height = 5, fig.align = "center", fig.path = "collegeFigs/", fig.show='hold')
```
...
## Figure 1(a) & 1(b):
```{r unsortedHeatmap,  fig.width = 5, fig.height = 5}
# Figure 1(a):
...
## Figure 4:
```{r, GPDP, fig.width=6, fig.height=5}
# Filter matrix:
...
```{r, ZPDP, fig.width=6, fig.height=6}
