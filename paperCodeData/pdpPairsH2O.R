...
predData <- predictFun(fit, as.h2o(data)) ## ADD
...
pData_1 <- predictFun(fit, as.h2o(pdplist1)) # ADD
pData_1 <- as.data.frame(pData_1) # ADD
pdplist1$fit <- pData_1$predict # ADD
...
pData_2 <- predictFun(fit, as.h2o(pdplist)) # ADD
pData_2 <- as.data.frame(pData_2) # ADD
pdplist$fit <- pData_2$predict # ADD
